...
are one of the most common artifacts in computer science courses.  @IFPR can
learn from existing practices in performing code review.

@subsection[#:tag "s:pairprog"]{Pair Programming and IFPR}

This section explores some of the similarities and differences between IFPR
and Pair Programming (PP), and how they may work together, along three
dimensions: responsibility, skills developed, and dynamics.

Pair programming is a software development technique in which two programmers
work together on one computer. From one perspective, pair programming involves
a lot of in-flow peer feedback, due to the nature of the working relationship.
The first main difference between IFPR and PP is that in IFPR each student may
get multiple reviews from other students.  But in mutual review situations 
(discussed in @secref["s:reviews"]), where students form dyads that review one
another, the situation is closer.  We discuss PP relative to this mutual
reviewing setup.
...
each student is responsible for his or her own artifact. This can naturally
...
@item{@bold{Skills}:
The skills required and developed in IFPR and in PP also differ.  PP deals
...
work face-to-face, but also focuses on the high-level skill of performing
...
work, namely, time spent on their own assignment versus time spend on doing
reviews. This trade-off is not present in PP.  To continue the analogy with
...
Finally, with IFPR, students are compelled to review other students' code, and
cannot ignore the problem and let their partner do the work.  On the other
